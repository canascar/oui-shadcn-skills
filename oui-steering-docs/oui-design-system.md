...
- Outer paths (arc + bottom swirl): `#006BB4` — matches `--brand-primary` in light mode
- Center swirl: `#003559` (deep navy)
- On dark backgrounds: use `#BAE6FD` (sky-200) for center swirl, `#0EA5E9` (sky-400) for outer paths
- In dark mode, `--brand-primary` shifts to `#0EA5E9` (sky-400) and center swirl lightens to `#BAE6FD` (sky-200)
